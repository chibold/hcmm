...
x_coord=1000				# Lato x dello scenario
y_coord=1000				# Lato y dello scenario
rows=4					# Numero di righe della griglia
columns=4				# Numero di colonne della griglia
tx_range=20				# Range trasmissivo dei nodi
rewiring_prob=0				# Probabilità di rewiring
...
travellers_number=0			# Numero dei viaggiatori
...
for seedRNG in "12" #"7" "11" "13" "15" "17" "19" "21" "23"
do
	echo Seed $seedRNG
